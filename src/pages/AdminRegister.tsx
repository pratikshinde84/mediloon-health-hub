  ...
  <div className="min-h-screen bg-background flex items-center justify-center p-6">
    <FadeUp className="w-full max-w-sm">
      ...
      <div className="bg-card rounded-2xl border border-border shadow-card p-6">
        <h2 className="text-xl font-bold text-foreground mb-1">Create Admin Account</h2>
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="Admin Name" className="w-full h-11 pl-10 pr-4 rounded-lg border border-input bg-background text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring/30 transition-shadow" />
            </div>
          </div>
          <div>
        ...
        <p className="text-sm text-muted-foreground text-center mt-5">
          Already registered? <Link to="/admin/login" className="text-primary font-medium hover:underline">Sign in</Link>
        </p>
      </div>
    </FadeUp>
  </div>
